...
import JittedIsingProcess as Ising
...
def run_dynamics(depth, kappa, T, p, beta, bias, bd_condition, load_data = False, use_bc = False):
	...
	f = "IsingModelResults/dynamics/dynamics_kappa{}_depth{}_p{}_beta{}_T{}_bias{}".format(kappa,depth,p,beta,T,bias)
	jointf = "IsingModelResults/dynamics/joint_dynamics_kappa{}_depth{}_p{}_beta{}_T{}_bias{}".format(kappa,depth,p,beta,T,bias)
	...
	joint_probs = Ising.simulate_parallel_glauber_dynamics(graph,T,p,beta,bd_condition,bias, N, use_bc)
